...
function Fn(e, t, r, i, u, f, v) {
  ...
  function C(t, n) {
    t.getRGB(In, g(e)), i.buffers.color.setClear(In.r, In.g, In.b, n, v);
  }
  return {
        ...
        ? (void 0 === T &&
            ((T = new o(
              ...
              new l({
                ...
                uniforms: d(yn.backgroundCube.uniforms),
          ...
          (void 0 === S &&
            ((S = new o(
              ...
              new l({
                ...
                uniforms: d(yn.background.uniforms),
...
class tr {
  ...
  fromScene(e, t = 0, n = 0.1, r = 100, i = {}) {
    const { size: a = 256, position: o = er } = i;
  ...
  _allocateTargets() {
    ...
    if (
      ...
      null !== this._pingPongRenderTarget && this._dispose(),
        (this._pingPongRenderTarget = nr(e, t, n));
  ...
  _sceneToCubeUV(e, t, n, r, i) {
    const a = new U(90, 1, t, n),
      ...
      f = u.autoClear,
      p = u.toneMapping;
    u.getClearColor(Yn), (u.toneMapping = D), (u.autoClear = !1);
    const m = new w({
  ...
  _textureToCubeUV(e, t) {
    ...
    rr(t, 0, 0, 3 * s, 2 * s), n.setRenderTarget(t), n.render(a, Xn);
  }
  _applyPMREM(e) {
...
function Rr(e, t, n) {
  ...
  const i = t * n;
  let a = Er[i];
  if ((void 0 === a && ((a = new Float32Array(i)), (Er[i] = a)), 0 !== t)) {
    r.toArray(a, 0);
...
function Cr(e, t) {
  let n = Sr[t];
  void 0 === n && ((n = new Int32Array(t)), (Sr[t] = n));
...
function Pr(e, t) {
  ...
  if (void 0 !== t.x)
    ...
    if (Ar(n, t)) return;
    e.uniform2fv(this.addr, t), br(n, t);
  }
}
function Ur(e, t) {
  const n = this.cache;
  if (void 0 !== t.x)
    ...
    if (Ar(n, t)) return;
    e.uniform3fv(this.addr, t), br(n, t);
  }
}
function Dr(e, t) {
  const n = this.cache;
  if (void 0 !== t.x)
    ...
    if (Ar(n, t)) return;
    e.uniform4fv(this.addr, t), br(n, t);
  }
}
function wr(e, t) {
  const n = this.cache,
  ...
  if (void 0 === r) {
    if (Ar(n, t)) return;
    e.uniformMatrix2fv(this.addr, !1, t), br(n, t);
  } else {
    if (Ar(n, r)) return;
    xr.set(r), e.uniformMatrix2fv(this.addr, !1, xr), br(n, r);
  }
}
function yr(e, t) {
  const n = this.cache,
  ...
  if (void 0 === r) {
    if (Ar(n, t)) return;
    e.uniformMatrix3fv(this.addr, !1, t), br(n, t);
  } else {
    if (Ar(n, r)) return;
    Mr.set(r), e.uniformMatrix3fv(this.addr, !1, Mr), br(n, r);
  }
}
function Ir(e, t) {
  const n = this.cache,
  ...
  if (void 0 === r) {
    if (Ar(n, t)) return;
    e.uniformMatrix4fv(this.addr, !1, t), br(n, t);
  } else {
    if (Ar(n, r)) return;
    Tr.set(r), e.uniformMatrix4fv(this.addr, !1, Tr), br(n, r);
  }
}
function Nr(e, t) {
  const n = this.cache;
...
function Wr(e, t, n) {
  const r = this.cache,
    i = n.allocateTextureUnit();
  r[0] !== i && (e.uniform1i(this.addr, i), (r[0] = i)),
    n.setTexture3D(t || gr, i);
}
function Xr(e, t, n) {
  const r = this.cache,
    i = n.allocateTextureUnit();
  r[0] !== i && (e.uniform1i(this.addr, i), (r[0] = i)),
    n.setTextureCube(t || vr, i);
}
function Yr(e, t, n) {
  const r = this.cache,
    i = n.allocateTextureUnit();
  r[0] !== i && (e.uniform1i(this.addr, i), (r[0] = i)),
    n.setTexture2DArray(t || _r, i);
}
function Kr(e, t) {
  e.uniform1fv(this.addr, t);
}
function jr(e, t) {
  const n = Rr(t, this.size, 2);
  e.uniform2fv(this.addr, n);
}
function qr(e, t) {
  const n = Rr(t, this.size, 3);
  e.uniform3fv(this.addr, n);
}
function Zr(e, t) {
  const n = Rr(t, this.size, 4);
...
function Qr(e, t) {
  const n = Rr(t, this.size, 9);
  e.uniformMatrix3fv(this.addr, !1, n);
}
function Jr(e, t) {
  const n = Rr(t, this.size, 16);
...
function li(e, t, n) {
  const r = this.cache,
    i = t.length,
    a = Cr(n, i);
  Ar(r, a) || (e.uniform1iv(this.addr, a), br(r, a));
  for (let e = 0; e !== i; ++e) n.setTexture2D(t[e] || mr, a[e]);
}
function ci(e, t, n) {
  const r = this.cache,
    i = t.length,
    a = Cr(n, i);
  Ar(r, a) || (e.uniform1iv(this.addr, a), br(r, a));
  for (let e = 0; e !== i; ++e) n.setTexture3D(t[e] || gr, a[e]);
}
function di(e, t, n) {
  const r = this.cache,
    i = t.length,
    a = Cr(n, i);
  Ar(r, a) || (e.uniform1iv(this.addr, a), br(r, a));
  for (let e = 0; e !== i; ++e) n.setTextureCube(t[e] || vr, a[e]);
}
function ui(e, t, n) {
  const r = this.cache,
    i = t.length,
    a = Cr(n, i);
  Ar(r, a) || (e.uniform1iv(this.addr, a), br(r, a));
  for (let e = 0; e !== i; ++e) n.setTexture2DArray(t[e] || _r, a[e]);
}
class fi {
  constructor(e, t, n) {
    (this.id = e),
...
function gi(e, t, n) {
  ...
  for (hi.lastIndex = 0; ; ) {
    ...
    if ((l && (s |= 0), void 0 === c || ("[" === c && o + 2 === i))) {
      _i(n, void 0 === c ? new fi(s, e, t) : new pi(s, e, t));
      break;
    }
    {
      let e = n.map[s];
      void 0 === e && ((e = new mi(s)), _i(n, e)), (n = e);
    }
  }
}
class vi {
  constructor(e, t) {
    ...
    for (let r = 0; r < n; ++r) {
      ...
      gi(n, e.getUniformLocation(t, n.name), this);
    }
  }
  setValue(e, t, n, r) {
    const i = this.map[t];
...
function xi(e, t) {
  const n = (function (e) {
    p._getMatrix(Ti, p.workingColorSpace, e);
    const t = `mat3( ${Ti.elements.map((e) => e.toFixed(4))} )`;
...
const Ai = new i();
function bi() {
  p.getLuminanceCoefficients(Ai);
  return [
    "float luminance( const in vec3 rgb ) {",
    `\tconst vec3 weights = vec3( ${Ai.x.toFixed(4)}, ${Ai.y.toFixed(
      4
    )}, ${Ai.z.toFixed(4)} );`,
...
function Bi(e, t, n, r) {
  ...
  n.isRawShaderMaterial
    ...
    : ((g = [
      ...
      (v = [
        ...
        n.toneMapping !== D ? Dn.tonemapping_pars_fragment : "",
        n.toneMapping !== D ? Ri("toneMapping", n.toneMapping) : "",
        n.dithering ? "#define DITHERING" : "",
        n.opaque ? "#define OPAQUE" : "",
        Dn.colorspace_pars_fragment,
        xi("linearToOutputTexel", n.outputColorSpace),
        bi(),
  ...
  const S = E + g + s,
    T = E + v + l,
    M = Ei(i, i.VERTEX_SHADER, S),
    x = Ei(i, i.FRAGMENT_SHADER, T);
  function R(t) {
...
class Gi {
  ...
  _getShaderStage(e) {
    ...
    let n = t.get(e);
    return void 0 === n && ((n = new Vi(e)), t.set(e, n)), n;
  }
}
class Vi {
  constructor(e) {
    (this.id = Hi++), (this.code = e), (this.usedTimes = 0);
  }
}
function zi(e, t, n, r, i, o, s) {
  ...
  return {
    getParameters: function (o, l, f, S, T) {
      ...
      const Ce = {
        ...
        decodeVideoTexture:
          ...
          p.getTransfer(o.map.colorSpace) === m,
    ...
    acquireProgram: function (t, n) {
      ...
      return void 0 === r && ((r = new Bi(e, n, t, o)), f.push(r)), r;
    },
  ...
  return {
    ...
    sort: function (e, t) {
      n.length > 1 && n.sort(e || Wi),
        r.length > 1 && r.sort(t || Xi),
        i.length > 1 && i.sort(t || Xi);
    },
  };
}
function Ki() {
  ...
  this.render = function (t, n, r) {
    ...
    for (let o = 0, l = t.length; o < l; o++) {
      ...
      if (
        ...
        (a.x > m || a.y > m) &&
          (a.x > m &&
            ((s.x = Math.floor(m / h.x)),
            (a.x = s.x * h.x),
            (c.mapSize.x = s.x)),
          a.y > m &&
            ((s.y = Math.floor(m / h.y)),
            (a.y = s.y * h.y),
            (c.mapSize.y = s.y))),
        null === c.map || !0 === f || !0 === p)
      ) {
      ...
      !0 !== c.isPointLightShadow && this.type === J && x(c, r),
        (c.needsUpdate = !1);
    }
...
function na(e, t) {
    ...
    if (t !== y) {
      if ((!1 === m && (W(e.BLEND), (m = !0)), t === $e))
        (a = a || n),
          ...
          (s = s || i),
          (n === _ && a === E) ||
            (e.blendEquationSeparate(Y[n], Y[a]), (_ = n), (E = a)),
          (r === g && i === v && o === S && s === T) ||
        ...
        if (
          ((_ === Ae && E === Ae) ||
            (e.blendEquation(e.FUNC_ADD), (_ = Ae), (E = Ae)),
          d)
        )
          switch (t) {
            case pe:
  ...
  return {
    ...
    uniformBlockBinding: function (t, n) {
      ...
      o.get(n) !== r &&
        (e.uniformBlockBinding(n, r, t.__bindingPointIndex), o.set(n, r));
    },
...
function ra(e, n, r, i, a, o, s) {
  ...
  function C(e, t) {
    return !0 === E(e) ||
      (e.isFramebufferTexture && e.minFilter !== Te && e.minFilter !== B)
  ...
  function G(t, n, s) {
    ...
    if (d.version !== u.__version || !0 === c) {
      ...
      if (n.isDepthTexture)
        ...
        R
          ? (L &&
              r.texStorage3D(e.TEXTURE_3D, U, S, m.width, m.height, m.depth),
            P &&
              r.texSubImage3D(
                e.TEXTURE_3D,
                0,
  ...
  function W(t) {
    ...
    if (t.depthTexture && !n.__autoAllocateDepthBuffer) {
      ...
      e && e.length > 0
        ? k(n.__webglFramebuffer[0], t)
        : k(n.__webglFramebuffer, t);
    } else if (a) {
      n.__webglDepthbuffer = [];
      for (let i = 0; i < 6; i++)
        if (
        ...
        ? (function (t, n, s) {
            ...
            if (c.version !== d.__version || !0 === l) {
              ...
              if ((O(e.TEXTURE_CUBE_MAP, n), f)) {
                R &&
                  b &&
                  r.texStorage2D(e.TEXTURE_CUBE_MAP, U, T, _.width, _.height);
                for (let t = 0; t < 6; t++) {
                  P = h[t].mipmaps;
  ...
  constructor(e, n) {
    ...
    (this.cameraAutoUpdate = !0),
      ...
      (this.getController = function (e) {
        let t = T[e];
        return (
          void 0 === t && ((t = new Sn()), (T[e] = t)), t.getTargetRaySpace()
        );
      }),
      (this.getControllerGrip = function (e) {
        let t = T[e];
        return void 0 === t && ((t = new Sn()), (T[e] = t)), t.getGripSpace();
      }),
      (this.getHand = function (e) {
        let t = T[e];
        return void 0 === t && ((t = new Sn()), (T[e] = t)), t.getHandSpace();
      }),
  ...
  function r(e, r) {
    ...
    a &&
      ...
      a.isCubeTexture &&
        ...
        ((sa.y *= -1), (sa.z *= -1)),
      e.envMapRotation.value.setFromMatrix4(la.makeRotationFromEuler(sa)),
      (e.flipEnvMap.value =
  ...
  constructor(e = {}) {
    ...
    function Oe() {
      (le = new lr(Ie)),
        le.init(),
        (De = new ia(Ie, le)),
        (ce = new Gn(Ie, le, e, De)),
        (de = new na(Ie, le)),
        ce.reverseDepthBuffer && g && de.buffers.depth.setReversed(!0),
        (ue = new ur(Ie)),
        (pe = new ki()),
        (me = new ra(Ie, le, de, pe, ce, De, ue)),
        (he = new zn(C)),
        (_e = new sr(C)),
        (ve = new Un(Ie)),
        (we = new Bn(Ie, ve)),
        (Ee = new cr(Ie, ve, ue, we)),
        (Se = new pr(Ie, Ee, ve, ue)),
        (Le = new fr(Ie, ce, me)),
        (Ae = new Vn(pe)),
        (Te = new zi(C, he, _e, le, ce, we, Ae)),
        (Me = new ca(C, pe)),
        (xe = new Ki()),
        (Re = new Ji(le)),
        (Ce = new Fn(C, he, _e, de, Se, v, d)),
        (be = new ea(C, Se, ce)),
        (ye = new da(Ie, ue, ce, de)),
        (Pe = new Hn(Ie, le, ue)),
        (Ue = new dr(Ie, le, ue)),
        ...
        const o = i.isMesh && i.matrixWorld.determinant() < 0,
          s = (function (e, t, n, r, i) {
            ...
            M &&
              ...
              vi.upload(Ie, Je(g), b, me));
            var P, U;
            r.isShaderMaterial &&
              !0 === r.uniformsNeedUpdate &&
              (vi.upload(Ie, Je(g), b, me), (r.uniformsNeedUpdate = !1));
    ...
    function qe(e, t, n, r) {
      ...
      if (
        ...
        !0 === e &&
          (me.updateMultisampleRenderTarget(i), me.updateRenderTargetMipmap(i));
      }
      C.setRenderTarget(s),
        C.setClearColor(V, z),
    ...
    function Je(e) {
      if (null === e.uniformsList) {
        ...
        e.uniformsList = vi.seqWithValue(t.seq, e.uniforms);
      }
    ...
    (this.setRenderTarget = function (e, t = 0, n = 0) {
      ...
      if (e) {
        ...
        O.copy(q).multiplyScalar(Y).floor(),
          B.copy(Z).multiplyScalar(Y).floor(),
          (G = $);
      0 !== n && (i = tt);
      if (
